...
AS $$
DECLARE
  project_url TEXT := 'https://alpihmjlmmjwweiotjij.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFscGlobWpsbW1qd3dlaW90amlqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMTI2Nzg0NCwiZXhwIjoyMDM2ODQzODQ0fQ.nODCnWS-pXfC3QD4VRldOzXYfsOE7nd2DqNcEE-ql68'; -- full access needed for http request to storage
