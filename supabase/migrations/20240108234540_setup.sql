...
AS $$
DECLARE
  project_url TEXT := 'https://ycurnbjvqbiwmjjdfphv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InljdXJuYmp2cWJpd21qamRmcGh2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMTQ4MTY4MCwiZXhwIjoyMDM3MDU3NjgwfQ.G4J3-Sj3svheQHLgnesYqFDb-5CwLdUVrcuzF5Mel5k'; -- full access needed for http request to storage
